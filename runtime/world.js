...
const getLambdaRemote = require('./getLambdaRemote.js');
...
const lambdatestStackDriver = require('./lambdatestStackDriver');

const remoteService = getLambdaRemote(global.settings.remoteService);
...
async function getDriverInstance() {
  ...
  if (remoteService && remoteService.type === 'lambdatest') {
    ...
    browser = lambdatestStackDriver(options, configType);
    return browser;
  }
